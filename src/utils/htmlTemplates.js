...
<table id="u_content_text_3" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">Please Verify that your email address is </span><span style="font-size: 16px; line-height: 27.2px;">${email} and that you entered it when </span><span style="font-size: 16px; line-height: 27.2px;">signing up for Trello App.</span></p>
  </div>
      </td>
    </tr>
  </tbody>
...
<div align="center">
    <a href="https://trello-xvz4.onrender.com/users/confirmAccount/${token}" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #000000; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:50%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
...
export const forgetTemplate = (code) => `<h3>Your Reset Code is ${code}</h3>`;
